...
function init(data) {
    for (var i = 0; i < 32000; i++) {
        var value = data.readUInt16LE(i * 2);
        var div = value + (value === 0 ? 0 : 36109);
        divs.push( div );
    }
    console.log( ';; init done: ' + divs.length + ' divs read' );
}
